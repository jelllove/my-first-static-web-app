(function () {
    ...
    n = function (r, i) {
        ...
        m = {
            ...
            getBrowser: function () {
                ...
                return s = s ? s[0] : "",
                s == "msie" ? s = l.match(/msie[^;]+/) + "" : s == "trident" && l.replace(/trident\/[0-9].*rv[ :]([0-9.]+)/ig, function (e, t) {
                        s = "msie " + t
                    }),
                s
            },
            ...
            getContainerId: function (e) {
                ...
                while (e) {
                    if (e.attributes && ("bk" in e.attributes || "data-bk" in e.attributes)) {
                        ...
                        if (n)
                            return n = "bk:" + n, n.substr(0, r);
                        if (e.id)
                            return n = e.getAttribute("data-desc") || e.id, n.substr(0, r)
    ...
    (window);
    n.setConf({
        trackUrl: "http://www.jelllove.com",
        clickUrl: "http://www.jelllove.com",
        clickHeatMapUrl: "http://www.jelllove.com",
        wpoUrl: "http://www.jelllove.com"
    }),
